...
The developer content and samples are installed upon successful installation of the SDK. For specific instructions on how to install the Enterprise SDK, see [how to install the ArcGIS Enterprise SDK](../installation-net/).
...
Starting at 10.8.1, it is possible to create SOEs and SOIs that interact with a utility network dataset. To learn more, see [Work with utility networks](../work-with-utility-networks-net/).
