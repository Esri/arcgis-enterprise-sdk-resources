...
-   [Developing Extensions with ArcGIS Enterprise SDK](../developing-extensions-with-arcgis-enterprise-sdk/)—Introduction on how to get started with development of SOEs and SOIs using .NET and Java.
-   [Enterprise SDK .NET Namespaces](reference.html)— Enterprise SDK Application programming interface (API) help for .NET developers.
-   [Enterprise SDK JavaDoc](api/entsdk/index.html)— Enterprise SDK Java library help for Java developers.
