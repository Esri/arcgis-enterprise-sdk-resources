...
namespace NetFindNearFeaturesSoapSOE
{
    ...
    [ServerObjectExtension("MapServer",
        ...
        DefaultCapabilities = "GetInfo,FindFeatures,DemoCustomObject,DemoArrayOfCustomObjects",
    ...
    public class NetFindNearFeaturesSoapSOE : IRequestHandler2, IServerObjectExtension, IObjectConstruct
    {
        ...
        {
            IXMLSerializeData reqParams = reqMsg.Parameters;
            var p = FindParam("layerInfos", reqParams);
            var layerInfos = (CustomLayerInfos)reqParams.GetObject(p, Constants.SOENamespaceURI, "ArrayOfCustomLayerInfo");
        ...
        private IMapTableDescription GetTableDesc(IMapServer mapServer, int layerID)
        {
            ...
            for (int i = 0; i < c; i++)
            {
                ILayerDescription layerDesc = (ILayerDescription)layerDescs.get_Element(i);
        ...
        private IMapLayerInfo GetLayerInfo(IMapServer mapServer, int layerID)
        {
