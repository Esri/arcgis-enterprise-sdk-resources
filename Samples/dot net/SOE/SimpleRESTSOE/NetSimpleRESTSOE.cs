...
{
    [ComVisible(true)]
    [Guid("621ad529-eb33-4dee-8b64-50e5e0cf1045")]
    ...
    public class NetSimpleRESTSOE : IServerObjectExtension, IRESTRequestHandler
    {
        ...
        private RestResource CreateRestSchema()
        {
            ...
            RestResource srvcptopResource = new RestResource("serviceproperties", false, SrvcPropResHandler);
            soeResource.resources.Add(srvcptopResource);
