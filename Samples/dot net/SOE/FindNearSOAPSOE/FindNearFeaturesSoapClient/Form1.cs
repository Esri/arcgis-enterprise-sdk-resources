    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var nearFeatsService = new localhost.SampleWorldCities_NetFindNearFeaturesSoapSOE();
                //see Program.cs - the SSL certificate validation is disabled for local tests
                nearFeatsService.Url = "https://localhost:6443/arcgis/services/SampleWorldCities/MapServer/NetFindNearFeaturesSoapSOE";
