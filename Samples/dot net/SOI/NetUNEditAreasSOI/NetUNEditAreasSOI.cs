...
// Demo to show network edit areas from all active user versions in a single layer
// The SOI intercepts UtilityNetworkServer/validateNetworkTopology calls
// to get dirty areas created by network edits and updates the EditAreas layer
// with the extent being edited, along with extra information

namespace NetUNEditAreasSOI
{
    [ComVisible(true)]
    [Guid("318c9d75-b5f4-466f-ae7d-85f5dbf36dc9")]
