...
namespace DotNETImageServiceApplyWatermark
{
    [ComVisible(true)]
    [Guid("0feb1a6a-deea-49b7-8316-ac84ec3ffeb9")]
    ...
    public class DotNETImageServiceApplyWatermark : IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler, IRequestHandler2, IRequestHandler
    {
        ...
        public DotNETImageServiceApplyWatermark()
        {
