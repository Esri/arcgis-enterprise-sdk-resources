  ...
  public class SpatialFilterSOI : IServerObjectExtension, IRESTRequestHandler
  {
        ...
        string operationInput, string outputFormat, string requestProperties, out string responseProperties)
    {
      ...
      if (operationName == "export" || operationName == "identify" || operationName == "find")
      {
        ...
        if (joOperationInput.Exists("spatialFilter"))
          joOperationInput.Delete("spatialFilter");

        var joSpatialFilter = new JsonObject();
        joSpatialFilter.AddString("spatialRel", "esriSpatialRelIntersects"); 
        joSpatialFilter.AddString("geometryType", "esriGeometryPolygon");
        joSpatialFilter.AddJsonObject("geometry", CreateACircle());
        joOperationInput.AddJsonObject("spatialFilter", joSpatialFilter);
