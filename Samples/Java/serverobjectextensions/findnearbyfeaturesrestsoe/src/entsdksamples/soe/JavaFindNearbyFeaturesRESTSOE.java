...
@ArcGISExtension
@ServerObjectExtProperties(displayName = "Java Find Nearby Features REST SOE", description = "Java Find Nearby Features REST SOE")
public class JavaFindNearbyFeaturesRESTSOE implements IServerObjectExtension,
	IRESTRequestHandler {
    ...
    /**
     * Method for implementing REST operation "op11"'s functionality.
     * 
     * @resourceId String id of element of sub resource, which is a collection
     * @param String
