...
@ArcGISExtension
@ServerObjectExtProperties(displayName = "Java Simple REST SOE", description = "Java Simple REST SOE.", defaultSOAPCapabilities = "", allSOAPCapabilities = "", properties = "")
public class JavaSimpleRESTSOE implements IServerObjectExtension,
	IRESTRequestHandler {
    ...
    public JSONObject getPropertiesInfoAsJSON() throws Exception {
    	...
    	json.put("MaxBufferCount", this.pPropertyset.getProperty("MaxBufferCount").toString());
