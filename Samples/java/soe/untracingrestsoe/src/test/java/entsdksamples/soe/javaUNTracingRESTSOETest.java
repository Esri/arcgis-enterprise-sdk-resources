...
public class javaUNTracingRESTSOETest {

	//Test method for GetSchema
	@Test
	public void testGetSchema() throws Exception {
				JavaUNTracingRESTSOE JavaUNTracingRESTSOE = new JavaUNTracingRESTSOE();
		String schemaJSON = JavaUNTracingRESTSOE.getSchema();
