 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="TableEdits" type="{http://www.esri.com/schemas/ArcGIS/10.7}ArrayOfTableEdit"/&amp;gt;
...
@XmlRootElement(name = "ApplyEdits")
public class ApplyEdits {

    @XmlElement(name = "TableEdits", required = true)
    protected ArrayOfTableEdit tableEdits;
    ...
    /**
     * Gets the value of the tableEdits property.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfTableEdit }
     *     
     */
    public ArrayOfTableEdit getTableEdits() {
        return tableEdits;
    }

    /**
     * Sets the value of the tableEdits property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfTableEdit }
     *     
     */
    public void setTableEdits(ArrayOfTableEdit value) {
        this.tableEdits = value;
    }
