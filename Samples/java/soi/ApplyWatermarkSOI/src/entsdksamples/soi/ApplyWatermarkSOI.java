...
@ArcGISExtension
@ServerObjectExtProperties(displayName = "Watermark SOI",
description = "Overlays a watermark on the export image operation", interceptor = true, servicetype = "MapService")
public class ApplyWatermarkSOI implements IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler,
IRequestHandler2, IRequestHandler {
  ...
  private SOIHelper soiHelper;
	 ...
	 * @param sourceImageBA Image data in a byte array
