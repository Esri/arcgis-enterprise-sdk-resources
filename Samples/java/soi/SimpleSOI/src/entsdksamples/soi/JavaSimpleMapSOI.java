...
public class JavaSimpleMapSOI implements IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler,
  ...
  public void init(IServerObjectHelper soh) throws IOException, AutomationException {
    ...
    if(arcgisHome == null) {
      serverLog.addMessage(1, 200,
          "Could not get ArcGIS home directory. Check if environment variable " + ARCGISHOME_ENV + " is set.");
  ...
  public byte[] handleRESTRequest(String capabilities, String resourceName, String operationName,
    ...
    */
    serverLog.addMessage(3, 200,
        "Request logged in SampleSOI. User: " + getLoggedInUserName() + ", Operation: " + 
    ...
    if (restRequestHandler != null) {
      // Return the response
      return restRequestHandler.handleRESTRequest(capabilities, resourceName, operationName,
