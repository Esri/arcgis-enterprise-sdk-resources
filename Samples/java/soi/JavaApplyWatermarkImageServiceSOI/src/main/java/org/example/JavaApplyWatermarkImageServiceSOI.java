...
@ServerObjectExtProperties(displayName = "Watermark ImageService SOI",
		description = "Overlays a watermark on the export image operation", interceptor = true, servicetype = "ImageService",supportsSharedInstances = false)
public class JavaApplyWatermarkImageServiceSOI implements IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler,
	 ...
	 * @throws Exception
	 */
	public JavaApplyWatermarkImageServiceSOI() throws Exception {
		super();
	}
