 ...
 *
 * In this sample we demonstrate how to add watermark to output image generated by the export image
 * operation.
 */

@ArcGISExtension
@ServerObjectExtProperties(displayName = "Watermark ImageService SOI",
...
public class ApplyWatermarkImageServiceSOI implements IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler,
	 ...
	 * @throws Exception
	 */
	public ApplyWatermarkImageServiceSOI() throws Exception {
		super();
	}
	...
	public void init(IServerObjectHelper soh) throws IOException, AutomationException {
		...
		if(!arcgisHome.endsWith(File.separator)) arcgisHome += File.separator;
		// Load the SOI helper.
		String imageServiceWSDLPath = arcgisHome + "framework#runtime#ArcGIS#Resources#XmlSchema".replace("#", File.separator) + File.separator + "ImageServer.wsdl";
		serverLog.addMessage(1, 200, "Image Service WSDL path " + imageServiceWSDLPath + " is set.");
		this.soiHelper = new SOIHelper(imageServiceWSDLPath);
	...
	public byte[] handleRESTRequest(String capabilities, String resourceName, String operationName,
		...
		if (restRequestHandler != null) {
			...
			if (operationName.equalsIgnoreCase("exportImage")) {
				try {
	...
	private byte[] bufferedImagetoByteArray(BufferedImage sourceImage, String imageType) throws IOException {
		...
		ImageIO.write(sourceImage, (imageType.endsWith("png")) ? "PNG" : imageType, baos);
		baos.flush();
	...
	private byte[] addTextWatermark(String watermarkText, String fileName, BufferedImage sourceImage, String imageType,
		...
		if (outputFormat.equalsIgnoreCase("image")) {
			...
			ImageIO.write(sourceImage, (imageType.endsWith("png")) ? "PNG" : imageType, os);
