...
public class JavaClippingSOI
	 ...
	 * @throws Exception
	 */
	public JavaClippingSOI() throws Exception {
		super();
	}
	...
	public String handleStringRequest(String capabilities, String request) throws IOException, AutomationException {
		// Log message with server
		serverLog.addMessage(3, 200, "Request received in JavaClippingSOI Interceptor for handleStringRequest");
	...
	public byte[] handleStringWebRequest(int httpMethod, String requestURL, String queryString, String capabilities,
			...
			throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in JavaClippingSOI Interceptor for handleStringWebRequest");
	...
	public byte[] handleBinaryRequest2(String capabilities, byte[] request) throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in JavaClippingSOI Interceptor for handleBinaryRequest2");
	...
	public String getSchema() throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in JavaClippingSOI Interceptor for getSchema");
	...
	public byte[] handleBinaryRequest(byte[] request) throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in JavaClippingSOI Interceptor for handleBinaryRequest");
