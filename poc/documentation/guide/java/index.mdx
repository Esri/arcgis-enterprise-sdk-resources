...
Refer to the section [design philosophy](../java/design-philosophy-for-arcgis-enterprise-sdk-java/) to understand the fundamental principles behind the ArcGIS Enterprise SDK.
...
Refer to the [Migration strategies](../java/migration-strategies-java/) section on how to migrate extensions developed using ArcObjects Java SDK into the ArcGIS Enterprise SDK.

### Also See

- [Design philosophy](../java/design-philosophy-for-arcgis-enterprise-sdk-java/)
- [Install ArcGIS Enterprise SDK](../java/install-arcgis-enterprise-sdk-java/)
